var ddsmoothmenu={
    ...
    arrowimages: {
        down:['downarrowclass', 'imagenes/menu/down.gif',25], 
        right:['rightarrowclass', 'imagenes/menu/right.gif']
        },
    transition: {
        overtime:100, 
        outtime:100
    ...
    buildmenu:function($, setting){
        ...
        $headers.each(function(i){ //loop through each LI header
            ...
            $curobj.children("span:eq(0)").css(this.istopheader? {
    ...
    init:function(setting){
        if (typeof setting.customtheme=="object" && setting.customtheme.length==2){ //override default menu colors (default/hover) with custom set?
            ...
            document.write('<style type="text/css">\n'
                +mainselector+' ul li span {background:'+setting.customtheme[0]+';}\n'
                +mainmenuid+' ul li span:hover {background:'+setting.customtheme[1]+';}\n'
                +'</style>')
        }
